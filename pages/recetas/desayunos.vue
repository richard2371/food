                ...
                <VCardText>
                    <VRow>
                        ...
                        <VCol cols="12" md="8">
                            ...
                            <VRow class="mt-2">
                                <VCol cols="12" md="7">
                                    <VSelect label="Categoría" :items="['Desayuno']" v-model="form.categoria"
...
const openDialog = () => {
    form.value = { id: null, nombre: '', categoria: 'Desayuno', tiempo: '', descripcion: '', ingredientes: [], cocinado: false, imagenURL: '' }
    dialog.value = true
}
