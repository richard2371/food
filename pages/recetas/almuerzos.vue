<template>
    <VContainer fluid class="pa-2">
        ...
        <VRow align="center" justify="space-between" class="mb-2">
            <h3><VIcon>mdi-food-steak</VIcon> Almuerzos</h3>
                ...
                <VCardText>
                    <VRow>
                        ...
                        <VCol cols="12" md="8">
                            ...
                            <VRow class="mt-2">
                                <VCol cols="12" md="7">
                                    <VSelect label="Categoría" :items="['Almuerzo']" v-model="form.categoria"
...
const form = ref({
    id: null, nombre: '', categoria: 'Almuerzo', tiempo: '', descripcion: '', ingredientes: [], cocinado: false, imagenURL: ''
})
...
const openDialog = () => {
    form.value = { id: null, nombre: '', categoria: 'Almuerzo', tiempo: '', descripcion: '', ingredientes: [], cocinado: false, imagenURL: '' }
    dialog.value = true
}
