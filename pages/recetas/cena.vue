<template>
    <VContainer fluid class="pa-2">
        ...
        <VRow align="center" justify="space-between" class="mb-2">
            <h3> <VIcon>mdi-food-turkey</VIcon> Cenas</h3>
            <VBtn icon color="primary" @click="openDialog">
                <VIcon>mdi-plus</VIcon>
            </VBtn>
        </VRow>

        <!-- LISTA DE RECETAS SOLO Cenas -->
        <VRow dense>
            <VCol v-for="r in recetasCenas" :key="r.id" cols="12" sm="6" md="4">
                ...
                <VCardText>
                    <VRow>
                        ...
                        <VCol cols="12" md="8">
                            ...
                            <VRow class="mt-2">
                                <VCol cols="12" md="7">
                                    <VSelect label="Categoría" :items="['Cena']" v-model="form.categoria"
...
const form = ref({
    id: null, nombre: '', categoria: 'Cena', tiempo: '', descripcion: '', ingredientes: [], cocinado: false, imagenURL: ''
})
...
const recetasCenas = computed(() => {
// alert(1)
  return recetas.value
    .filter(r => r.categoria === 'Cena')
    .slice()
    .sort((a, b) => {
      const prioridad = (r) => {
...
const openDialog = () => {
    form.value = { id: null, nombre: '', categoria: 'Cena', tiempo: '', descripcion: '', ingredientes: [], cocinado: false, imagenURL: '' }
    dialog.value = true
}
